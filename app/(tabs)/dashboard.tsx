...
const MODULES: Module[] = [
  ...
  { key: "maintenance", label: "Maintenance", icon: "construct-outline", tint: "#f97316", roles: ["super_admin", "ops_manager", "technician"], target: { web: "/maintenance", title: "Maintenance" } },
  { key: "inventory", label: "Inventory", icon: "cube-outline", tint: "#22c55e", roles: ["super_admin", "ops_manager", "warehouse"], target: { web: "/inventory", title: "Inventory" } },
  { key: "procurement", label: "Procurement", icon: "cart-outline", tint: "#ef4444", roles: ["super_admin", "ops_manager", "finance"], target: { web: "/procurement", title: "Procurement" } },
  ...
  { key: "vendors", label: "Vendors", icon: "car-outline", tint: "#64748b", roles: ["super_admin", "ops_manager"], target: { web: "/suppliers", title: "Vendors" } },
